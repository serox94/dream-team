(async () => {
  ...
  function applyDynamicTripContent(trip, docs) {
    ...
    if (path.endsWith('/pages/mapa.html')) {
    ...
    if (path.endsWith('/pages/regulamin.html') && docs.length) {
    ...
    if (path.endsWith('/pages/porady.html') && docs.length) {
      const main = document.querySelector('main.container.page-content');
    ...
    if (path.endsWith('/pages/dojazd.html') && docs.length) {
      const main = document.querySelector('main.container.page-content');
